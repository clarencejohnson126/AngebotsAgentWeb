...
export const DEMO_PROJECTS: Project[] = [
  {
    ...
    title: 'Bürogebäude RISE Mannheim',
    project_number: '2024-001',
    description: 'Neubau Bürogebäude mit 5 Geschossen, ca. 3.500 m² Trockenbaufläche',
    client_name: 'RISE Projektentwicklung GmbH',
    client_contact: 'Herr Schmidt',
    client_email: 'schmidt@rise-projekt.de',
    client_phone: '+49 621 987654',
    client_address: 'Augustaanlage 50, 68165 Mannheim',
    site_street: 'Augustaanlage 29',
    site_zip_code: '68165',
    site_city: 'Mannheim',
...
export const DEMO_DOCUMENTS: Document[] = [
  {
    ...
    original_filename: 'LV_Trockenbau_RISE_2024.pdf',
  ...
  },
  {
    ...
    project_id: 'project-001',
    name: 'Grundriss EG',
    original_filename: 'GR_EG_RISE_A101.pdf',
  ...
  },
  {
    ...
    project_id: 'project-001',
    name: 'Grundriss 1.OG',
    original_filename: 'GR_1OG_RISE_A102.pdf',
  ...
  },
  {
    ...
    original_filename: 'Baubeschreibung_RISE_2024.pdf',
...
export const DEMO_OFFER_DRAFTS: OfferDraft[] = [
  {
    ...
    title: 'Angebot Trockenbauarbeiten RISE',
