    ...
    <div className="min-h-screen flex flex-col bg-[#fcfcfc]">
      ...
      <main className="flex-grow flex items-center justify-center p-12">
        <div className="text-center space-y-6">
          ...
          <h1 className="text-4xl font-black text-slate-900 brand-font">Ausschreibungen</h1>
          <p className="text-slate-500 italic max-w-md">Ausschreibungs-Pool durchsuchen und Potenziale finden.</p>
