...
export default function DemoSchnellscanPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = `flaechen-demo-${fileName.replace('.pdf', '')}-${Date.now()}.json`
    a.click()
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="border-b border-slate-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <Link href="/" className="inline-flex items-center text-slate-400 hover:text-white text-sm mb-2">
              <ArrowLeft className="h-4 w-4 mr-1" />
              Zurück zur Startseite
            </Link>
            <h1 className="text-2xl font-bold text-white">Schnellscan Demo</h1>
            <p className="text-sm text-slate-400 mt-1">
              Testen Sie die Raumflächen-Extraktion aus Grundrissen
            </p>
          </div>
            ...
            <div className="w-96">
                ...
                <div className="flex items-start gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                      Raumflächen werden automatisch aus Grundrissen extrahiert.
                    </p>
                  </div>
                </div>

                <div className="mb-6">
                  <p className="text-sm font-medium text-slate-400 mb-3">Flächenberechnung</p>
              ...
              <div className="mt-4 bg-blue-900/30 border border-blue-500/30 rounded-lg p-4">
                <p className="text-sm text-blue-300">
                  <span className="font-bold">Demo-Modus:</span> Dies ist eine Testversion. Für volle Funktionalität inkl. Projektverwaltung,{' '}
                  <Link href="/registrieren" className="underline hover:text-white">
