        ...
        <div className="max-w-7xl mx-auto space-y-12 italic">
          ...
          <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-x-12 gap-y-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
               ...
               <button type="button" onClick={(e) => navigateTo('#/impressum', e)} className="hover:text-slate-900 transition-colors">Impressum</button>
               <button type="button" onClick={(e) => navigateTo('#/datenschutz', e)} className="hover:text-slate-900 transition-colors">Datenschutz</button>
            </div>
          </div>
        </div>
      </footer>
