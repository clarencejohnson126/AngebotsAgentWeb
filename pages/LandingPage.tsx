          ...
          <div className="flex-1 flex flex-col items-center lg:items-start lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center space-y-4 sm:space-y-0 sm:space-x-6 w-full sm:w-auto px-4 sm:px-0">
              <button
                ...
                className="bg-blue-600 text-white px-8 py-4 sm:px-12 sm:py-6 rounded-full font-black text-base sm:text-xl hover:bg-blue-700 shadow-2xl shadow-blue-200 transition-all transform hover:-translate-y-1 w-full sm:w-auto"
              >
                {t.ctaDemo}
              </button>
              <button
                onClick={(e) => navigateTo('#/dashboard', e)}
                className="text-slate-900 px-8 py-4 sm:px-12 sm:py-6 rounded-full font-black text-base sm:text-xl hover:bg-slate-50 border-4 border-slate-900 transition-all w-full sm:w-auto"
              >
                {t.ctaLogin}
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 text-center lg:text-left space-y-8 md:space-y-12 lg:space-y-16">
            ...
            <div className="pt-4 md:pt-8">
              <button
                onClick={(e) => navigateTo('#/dashboard', e)}
                className="bg-slate-900 text-white px-10 py-5 md:px-16 md:py-6 lg:px-20 lg:py-8 rounded-full font-black text-base md:text-xl lg:text-2xl hover:bg-blue-600 shadow-xl md:shadow-3xl transition-all transform hover:-translate-y-2 w-full sm:w-auto"
              >
